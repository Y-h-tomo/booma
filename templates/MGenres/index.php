                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?= $this->Paginator->sort('del_flg', 'ON/OFF') ?></th>
                                    ...
                                    <?php foreach ($mGenres as $mGenre) : ?>
                                        <?php if ($mGenre->del_flg) : ?>
                                            <tr>
                                                ...
                                                <td class="text-white bg-secondary">OFF</td>
                                                <td>
                                                    <?php if ($role == '3') : ?>
                                                        <a href="#modal_<?= $mGenre->id ?>"><button type="button" class="btn btn-outline-success btn-sm">ON</button></a>

                                                        <div class="remodal col" data-remodal-id="modal_<?= $mGenre->id ?>">
                                                            <p>書籍管理に影響が出る可能性があります。本当にジャンル：<?= $mGenre->genre ?> をONしますか?</p>
                                                            <?= $this->Form->postButton(
                                                                __('ON'),
                                                                ['action' => 'edit', $mGenre->id],
                                        ...
                                        <?php else : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($role == '3') : ?>
                                                        <a href="#modal_<?= $mGenre->id ?>"><button type="button" class="btn btn-outline-danger btn-sm">OFF</button></a>

                                                        <div class="remodal col" data-remodal-id="modal_<?= $mGenre->id ?>">
                                                            <p>書籍管理に影響が出る可能性があります。本当にジャンル：<?= $mGenre->genre ?> をOFFしますか?</p>
                                                            <?= $this->Form->postButton(
                                                                __('OFF'),
                                                                ['action' => 'delete', $mGenre->id],
