        ...
        <div class="card">
            ...
            <div class="card-block">
                ...
                <div class="form-group row" id="js-genre-modal">
                    ...
                    <div class="remodal col" data-remodal-id="modal_b">
                        ...
                        <?php foreach ($genres as $g) : ?>
                            <input type="checkbox" value="<?= $g['id'] . ':' . $g['genre'] ?>" v-model="genres" v-bind:disabled="isDisabled" id="genre-btn-<?= $g['id'] ?>" class="genre-box">
                ...
                <div class="form-group row" id="js-quantity">
                    ...
                    <div class="col-sm-8">
                        <div class="btn-group" role="group">
                            <span v-for="number in numbers"><button @click.prevent="num(number)" v-bind:disabled="isDisabled" type="button" class="btn btn-light btn-sm">{{ number }}</button>
                            </span>
                        </div>
                ...
                <div class="form-group row" id="js-deadline">
                    ...
                    <div class="col-sm-8">
                        <button type="button" class="btn-outline-dark btn btn-sm" @click.prevent='threeDays' v-bind:disabled="inputDisabled">3days</button>
                        <button type="button" class="btn-outline-dark btn btn-sm" @click.prevent='oneWeek' v-bind:disabled="inputDisabled">1week</button>
                        <button type="button" class="btn-outline-dark btn btn-sm" @click.prevent='twoWeek' v-bind:disabled="inputDisabled">2week</button>
                        <button type="button" class="btn-outline-dark btn btn-sm" @click.prevent='threeWeek' v-bind:disabled="inputDisabled">3week</button>
                        <button type="button" class="btn btn-info btn-sm" @click.prevent='clear'>再選択</button>
                    </div>
