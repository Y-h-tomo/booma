...
$this->assign('title', 'Confirm Book : 書籍編集確認');
  ...
  <div class="col-sm-12">
    <div class="card">
      ...
      <div class="card-block">
        ...
        <?= $this->Form->postButton('Update - 更新する', ['controller' => 'TBooks', 'action' => 'edit_exec'], ['class' => 'btn btn-primary']) ?>
        <?= $this->Html->link(__('Back - 戻る'), ['action' => 'edit', $tBook['id']], ['type' => 'button', 'class' => 'button btn btn-outline-dark']) ?>
      </div>
    </div>
  </div>
</div>