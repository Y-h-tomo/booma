                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th><span class="badge badge-light"><?= $this->Paginator->sort('deadline', '最大レンタル時間') ?></span></th>
                                            ...
                                            <td class="actions">
                                                <?php if ($user_id) : ?>
                                                    <?php if (($tBook->remain) !== 0) : ?>
                                                        <a href="#modal_b<?= $tBook->id ?>"><button type="button" class="btn btn-warning btn-sm mt-1">レンタル</button></a>
                                                        <!-- /* --------------------------------- レンタルモーダルエリア -------------------------------- */ -->
                                                    ...
                                                    <?php if (($tBook->remain) < ($tBook->quantity)) : ?>
                                                        <a href="#modal_r<?= $tBook->id ?>"><button type="button" class="btn btn-dark btn-sm mt-1">返却</button></a>
                                                        <!-- /* --------------------------------- 返却モーダルエリア -------------------------------- */ -->
