 ...
 * @var \App\Model\Entity\TFavorite[]|\Cake\Collection\CollectionInterface $tFavorites
 */
$this->assign('title', 'My Favorite : お気に入り');
          ...
          <div class="card-block table-border-style">
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tbody>
                  <?php foreach (($tFavorites->toArray()) as $h) : ?>
                  <tr>
                    ...
                    <td class="rentals">
                      ...
                      <a href="#modal_b<?= $h['t_book']['id'] ?>"><button type="button"
                          class="btn btn-warning btn-sm">レンタル</button></a>
                      <!-- /* --------------------------------- レンタルモーダルエリア -------------------------------- */ -->
